                            ...
                            <form method="POST">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="AboutICI">
                                            <option selected><?php echo $fetch['Advertisement']; ?></option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="inputEmail4" value="<?php echo $fetch['Student_finance']; ?>" name="Finance">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="StatusStudent">
                                            <option selected><?php echo $fetch['Student_status']; ?></option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="StatusWork">
                                            <option selected><?php echo $fetch['Finance']; ?></option>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="Living">
                                            <option selected><?php echo $fetch['Student_lodge']; ?></option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="SchoolChoice">
                                            <option selected><?php echo $fetch['Student_choice']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1" name="WhyICI">
                                        <option selected><?php echo $fetch['Choice_why']; ?></option>
                            ...
                            <?php
                                if(isset($_POST['SubmitBtn'])) {  
                                    ...
                                    if(empty($AboutICI)) {
                                        ...
                                        $sql = "UPDATE school SET Student_status = '$StatusStudent', Student_finance = '$Finance', Advertisement = '$AboutICI', Student_lodge = '$Living', Student_choice = '$SchoolChoice', Choice_why = '$WhyICI', student_lrn = '$student_lrn'";
                                        

                                        if(mysqli_query($connect, $sql)) {
                                            echo "<script> alert('Information successfully Submited'); 
                                                window.location='About_One.php?student_lrn={$Confirmation}';</script>";
                                        } else {
