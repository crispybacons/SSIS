                            ...
                            <form method="POST">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="inputEmail4" value="<?php echo $fetch['Org_inside_name']; ?>" name="OrganizationInside">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputPassword4">Position / Title</label>
                                        <input type="text" class="form-control" id="inputPassword4" value="<?php echo $fetch['Org_inside_position']; ?>" name="PositionInside">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="inputEmail4">Name of Organization (Outside school)</label>
                                        <input type="text" class="form-control" id="inputEmail4" value="<?php echo $fetch['Org_outside_name']; ?>" name="OrganizationOutside">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputPassword4">Position / Title</label>
                                        <input type="text" class="form-control" id="inputPassword4" value="<?php echo $fetch['Org_outside_position']; ?>" name="PositionOutside">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <?php
                                if(isset($_POST['SubmitBtn'])) {  
                                    ...
                                    if(empty($OrganizationInside)) {
                                        ...
                                        $sql = "UPDATE student_organization SET Org_inside_name = '$OrganizationInside', Org_inside_position = '$PositionInside', Org_outside_name = '$OrganizationOutside', Org_outside_position = '$PositionOutside', student_lrn = '$Confirmation'";
                                        ...
                                        if(mysqli_query($connect, $sql)) {
                                            ...
                                            echo "<script> alert('Information successfully Submited'); 
                                                window.location='About_Six.php?student_lrn={$fetch['student_lrn']}';</script>";
                                        } else {
