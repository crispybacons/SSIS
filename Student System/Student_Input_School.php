                            ...
                            <?php
                                if(isset($_POST['SubmitBtn'])) {  
                                    ...
                                    if(empty($AboutICI)) {
                                        ...
                                        $sql = "INSERT INTO school (Student_status, Student_finance, Finance, Advertisement, Student_lodge, Student_choice, Choice_why, student_lrn)";
                                        $sql .= " VALUES ('$StatusStudent', '$Finance', '$StatusWork', '$AboutICI', '$Living', '$SchoolChoice', '$WhyICI', '$Confirmation');";
                                        
                                        
                                        if(mysqli_query($connect, $sql)) {
                                               
                                                echo "<script> window.location = 'Student_Input_Personal.php?student_lrn={$Confirmation}';</script>";
                                        } else {
