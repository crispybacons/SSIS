               ...
               <div class="container">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            ?>
                            <?php
                                    $sql = "SELECT * FROM `student_organization`                                          
                                            INNER JOIN student_info ON `student_organization`.`student_lrn` = student_info.student_lrn
                                            WHERE student_organization.student_lrn = '$student_lrn';";
                            ...
                            <form>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input readonly type="text" class="form-control" id="inputEmail4" placeholder="<?php echo $fetch['Org_inside_name']; ?>" name="OrganizationInside">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputPassword4">Position / Title</label>
                                        <input readonly type="text" class="form-control" id="inputPassword4" placeholder="<?php echo $fetch['Org_inside_position']; ?>" name="PositionInside">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="inputEmail4">Name of Organization (Outside school)</label>
                                        <input readonly type="text" class="form-control" id="inputEmail4" placeholder="<?php echo $fetch['Org_outside_name']; ?>" name="OrganizationOutside">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputPassword4">Position / Title</label>
                                        <input readonly type="text" class="form-control" id="inputPassword4" placeholder="<?php echo $fetch['Org_outside_position']; ?>" name="PositionOutside">
                                    </div>
                                </div>
                                <?php                                           
                                    echo "<a readonly type='button' class='btn btn-success' href='Student_Profile.php?student_lrn={$fetch['student_lrn']}'>Back</a>";   
                                ?>
                                <?php                                           
                                    echo "<a type='button' class='btn btn-primary' href='Student_Edit_Seven.php?student_lrn={$fetch['student_lrn']}'>Edit</a>";   
                                ?> 
                            </form> 
                        </div>
                    </div>
