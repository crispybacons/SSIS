                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                ?>
                                <?php                                           
                                    echo "<a type='button' class='btn btn-success' href='Student_Father.php?student_lrn={$fetch['student_lrn']}'>Next</a>";   
                                ?>
                            ...
                            <?php
                                if(isset($_POST['SubmitBtn'])) { 
                                    ...
                                    elseif(empty($Birthday)) {
                                        ...
                                        $sql = "INSERT INTO student_personal (Student_personal_id, Surname, Gender, Nickname, Civil_status, Age, Birthday, Birthplace, Parents_marital_status, Emergency_contact, student_lrn)";
                                        $sql .= " VALUES ('$Confirmation', '$Middlename', '$Gender', '$Nickname', '$CivilStatus', '$Age', '$Birthday', '$PlaceBirth', '$ParentsStatus', '$EmergencyNumber', '$Confirmation');";
