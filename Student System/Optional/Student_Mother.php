                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
                                ...
                                ?>
                                <?php                                           
                                    echo "<a type='button' class='btn btn-success' href='Student_Siblings.php?student_lrn={$fetch['student_lrn']}'>Next</a>";   
                                ?>
                                ...
                                if(isset($_POST['SubmitBtn'])) {  
                                    ...
                                    if(empty($MotherName)) {
                                        ...
                                        if(mysqli_query($connect, $sql)) {
                                            ...
                                            echo "<script> alert('Failed to Submit information'); window.location='Student_Siblings.php?student_lrn={$fetch['student_lrn']}'  </script>";
                                        }
                                    }    
                                }
                            ?>
